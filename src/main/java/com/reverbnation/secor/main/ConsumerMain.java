 ...
 */
package com.reverbnation.secor.main;
...
public class ConsumerMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOG.info("starting " + secorConfig.getConsumerThreads() + " consumer threads");
            LinkedList<Consumer> consumers = new LinkedList<Consumer>();
            for (int i = 0; i < secorConfig.getConsumerThreads(); ++i) {
                Consumer consumer = new Consumer(secorConfig);
